...
def compress_and_store_context() -> str:
    ...
    api_args["messages"] = [
        {"role": "system", "content": (
            ...
            "CRITICAL: The 'user' message MUST contain two distinct sections:\n"
            "1. 'Current State': A summary of what has been accomplished so far.\n"
            "2. 'Active Plan & Next Steps': Explicitly list the pending tasks, unanswered questions, "
            "or the exact next action the Brain was about to take before the context limit was reached. "
            "Do NOT let the Brain lose its train of thought."
        )},
